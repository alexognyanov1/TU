...
CREATE TABLE coaches(
	...
	hour_salary DECIMAL,
	CONSTRAINT EGN CHECK(CHAR_LENGTH(egn) = 10)
) ENGINE = InnoDB;
...
CREATE TABLE salaryPayments(
	...
	salaryAmount DOUBLE,
	dateOfPayment DATETIME NOT NULL,
	CONSTRAINT salaryCantBeNegative CHECK(salaryAmount >= 0),
	CONSTRAINT FOREIGN KEY(coach_id) REFERENCES coaches(id),
...
INSERT INTO sportGroups VALUES
	(NULL, 'Sofia-Mladost 1', 'Monday', '08:00:00', 1, 1),
...
INSERT INTO taxesPayments VALUES
	-- 2023 group 1
	(NULL, 1, 1, 200, 1,  2023, NOW()),
...
UPDATE coaches SET month_salary = 2200, hour_salary = 24 WHERE id = 1;
UPDATE coaches SET month_salary = 2300, hour_salary = 25 WHERE id = 2;
UPDATE coaches SET month_salary = 2800, hour_salary = 28 WHERE id = 3;
UPDATE coaches SET month_salary = 3000, hour_salary = 30 WHERE id = 4;
UPDATE coaches SET month_salary = 2450, hour_salary = 26 WHERE id = 5;
UPDATE coaches SET month_salary = 3200, hour_salary = 35 WHERE id = 6;

INSERT INTO coach_work (coach_id, group_id, number_of_hours, date) VALUES
	(1, 1, 2, '2023-03-07 08:45:55'),
	(1, 1, 2, '2023-03-14 08:45:55'),
	(1, 1, 2, '2023-03-21 08:45:55'),
	(1, 1, 2, '2023-03-28 08:45:55'),
	(1, 1, 2, '2023-04-04 08:45:55'),
	(1, 1, 2, '2023-04-11 08:45:55'),
	(2, 2, 2, '2023-03-07 08:45:55'),
	(2, 2, 2, '2023-03-14 08:45:55'),
	(2, 2, 2, '2023-03-21 08:45:55'),
	(2, 2, 2, '2023-03-28 08:45:55'),
	(2, 2, 2, '2023-04-04 08:45:55'),
	(2, 2, 2, '2023-04-11 08:45:55'),
	(2, 3, 2, '2023-04-02 08:45:55'),
	(2, 3, 2, '2023-04-09 08:45:55');